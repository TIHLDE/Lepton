...
@pytest.mark.parametrize("group_name", [AdminGroup.SOSIALEN.name, "ikke-admin"])
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (MembershipType.LEADER, True, True, status.HTTP_200_OK, GroupType.SPORTSTEAM),
        (MembershipType.LEADER, True, False, status.HTTP_200_OK, GroupType.SPORTSTEAM),
        (MembershipType.LEADER, False, True, status.HTTP_200_OK, GroupType.SPORTSTEAM),
        (MembershipType.LEADER, False, False, status.HTTP_200_OK, GroupType.SPORTSTEAM),
        ...
        (MembershipType.MEMBER, True, True, status.HTTP_200_OK, GroupType.SPORTSTEAM),
        (
            MembershipType.MEMBER,
            True,
            False,
        ...
        (MembershipType.MEMBER, False, True, status.HTTP_200_OK, GroupType.SPORTSTEAM),
        (
            MembershipType.MEMBER,
            False,
            False,
        ...
        (None, True, True, status.HTTP_403_FORBIDDEN, GroupType.SPORTSTEAM),
        (None, True, False, status.HTTP_403_FORBIDDEN, GroupType.SPORTSTEAM),
        (None, False, True, status.HTTP_200_OK, GroupType.SPORTSTEAM),
        (None, False, False, status.HTTP_403_FORBIDDEN, GroupType.SPORTSTEAM),
    ],
)
...
@pytest.mark.parametrize(
    ...
    (
        ...
        ("Sportsteam", GroupType.SPORTSTEAM),
    ),
)
