...
#### ⚙ Configuration
Most of the required configuration for local development is already set up in .envs/.local.
Still, the application requires some additional configuration in order to run.
